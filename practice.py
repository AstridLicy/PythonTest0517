...
# Then you want to write all the keys and the square root of their corresponding values in group3 into the 1-th (0-indexed) dictionary of group2 (e.g. if there is a key ’tom’ whose value is 4, then you need to write a key ‘tom’ whose value is the square root of 4 into group2). Write your codes to achieve this. 
# Write your codes below:


for key in group3.keys():
    group2[1][key] = math.sqrt(group3[key])
print(group2)
print(group3)